...
<div class="container" id="students">
	...
	<form method="POST" action="<?php echo 'formthankyou.php?q='.$table; ?>" id="form">
		<br>
		<div class="card">
		...
		<?php
			...
			?>
				...
				<br>
					...
					<input type="<?php echo $rows['type']; ?>" name="<?php echo $rows['Q_no']."[]"; ?>" value="<?php echo $ans['ans_id']; ?>" required><?php echo $ans['content']; ?><br>
...
if($rows['type']=="checkbox"){
			...
			<br>
					...
					<input type="<?php echo $rows['type']; ?>" name="<?php echo $rows['Q_no']."[]"; ?>" value="<?php echo $ans['ans_id']; ?>" ><?php echo $ans['content']; ?><br>
